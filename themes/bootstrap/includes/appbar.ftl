...
<#assign modelMenus = Static["org.apache.ofbiz.widget.model.MenuFactory"].getMenusFromLocation(applicationMenuLocation)>

<#assign menus = modelMenus.keySet()>
<#assign menuItemList = appModelMenu.menuItemList>
<#if menuItemList?has_content>
    <a class="menuTitle" href="<@ofbizUrl>${target?if_exists}</@ofbizUrl>">${applicationTitle}</a>
            ...
            <ul class="nav navbar-nav">
                <#list menuItemList as item>
                    ...
                    <#if (item.getLink().getTarget(context))?has_content>
                        ...
                        <#else>
                            <#if item.getParentPortalPageId(context)?has_content>
                                ...
                                <#assign portalPages = Static["org.apache.ofbiz.widget.portal.PortalPageWorker"].getPortalPages(parentPortalPageId, context)>
                    ...
                    <#if menus?seq_contains("${subMenuName}")>
                        <#assign subModelMenu = Static["org.apache.ofbiz.widget.model.MenuFactory"].getMenuFromLocation(applicationMenuLocation,subMenuName)>
